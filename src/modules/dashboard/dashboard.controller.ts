...
import { RequestAdminInitiative, RequestCoordinator } from "./dto/RequestCoordinators";
...
export class DashboardController {
    ...
    async AdminInitiative(@Query() query: RequestAdminInitiative) {
    ...
    async changeStatusToAdminInitiative(@Body() dto: ChangeCoordinatorStatusDto) {
        ...
        return { message:  `O administrador foi alterado para o status: ${status}`}
    }
}